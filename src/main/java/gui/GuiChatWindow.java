...
public class GuiChatWindow extends JFrame {
  ...
  private void textArea4KeyReleased(KeyEvent e) {
    ...
    if (e.getKeyCode() == 10 & !shiftpress) { // enter
      if (!textArea4.getText().trim().equals("")) {
        ...
        if (right) {
          ChatWindow
              .update_window(MessageType.SEND_NORMAL, this, msg, "", msg, !b.isFullyConnected());
        }
    ...
    contentPaneLayout.setVerticalGroup(
        contentPaneLayout.createParallelGroup()
            .addGroup(GroupLayout.Alignment.TRAILING, contentPaneLayout.createSequentialGroup()
                ...
                .addComponent(scrollPane4, GroupLayout.PREFERRED_SIZE, 59,
  ...
  public void append(String style, String text) {
    try {
      StyledDocument doc = (StyledDocument) textPane1
          .getDocument(); // Create a style object and then set the style attributes
