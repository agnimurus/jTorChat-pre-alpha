  ...
  private void ok(ActionEvent e) {
    ...
    if (textField1.getText().length() != 0) {
      try {
        ...
        if (tray_size < 1) {
          JOptionPane.showMessageDialog(null, textField1.getText() + " is an invalid number",
    ...
    if (textField2.getText().length() != 0) {
      try {
        ...
        if (buddy_size < 1) {
          JOptionPane.showMessageDialog(null, textField2.getText() + " is an invalid number",
              "Invalid Number", JOptionPane.ERROR_MESSAGE);
          return;
        }
    ...
    if (textField3.getText().length() != 0) {
      try {
        ...
        if (buddy_space < 1) {
          JOptionPane.showMessageDialog(null, textField3.getText() + " is an invalid number",
              "Invalid Number", JOptionPane.ERROR_MESSAGE);
          return;
        }
      ...
      //======== panel1 ========
      {
        ...
        panel1Layout.setHorizontalGroup(
            panel1Layout.createParallelGroup()
                ...
                .addGroup(panel1Layout.createSequentialGroup()
                    .addGroup(
                        panel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(
                        panel1Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                            .addComponent(textField1, GroupLayout.DEFAULT_SIZE, 132,
                                Short.MAX_VALUE)
                            .addComponent(textField2, GroupLayout.DEFAULT_SIZE, 132,
                                Short.MAX_VALUE)
                            .addComponent(textField3, GroupLayout.DEFAULT_SIZE, 132,
                                Short.MAX_VALUE))
                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED,
                        GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(scrollPane1, GroupLayout.PREFERRED_SIZE, 109,
                        ...
                        .addGroup(panel1Layout.createSequentialGroup()
                            ...
                            .addGroup(
                                panel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                    .addComponent(label1, GroupLayout.PREFERRED_SIZE, 28,
                                        GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(
                                panel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                    .addComponent(textField2, GroupLayout.PREFERRED_SIZE,
                                        GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(label2, GroupLayout.PREFERRED_SIZE, 28,
                                        GroupLayout.PREFERRED_SIZE))
                            .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                            .addGroup(
                                panel1Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                    .addComponent(textField3, GroupLayout.PREFERRED_SIZE, 28,
                                        GroupLayout.PREFERRED_SIZE)
                                    .addComponent(label3, GroupLayout.PREFERRED_SIZE, 25,
                                        GroupLayout.PREFERRED_SIZE)))
                        .addComponent(scrollPane1, GroupLayout.PREFERRED_SIZE,
                            GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                    .addGap(18, 18, 18)
                    .addComponent(label4, GroupLayout.PREFERRED_SIZE, 27,
                        GroupLayout.PREFERRED_SIZE)
