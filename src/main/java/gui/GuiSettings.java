...
public class GuiSettings extends JFrame {
  ...
  public GuiSettings() {
    ...
    initComponents();
    list1 = util.list.addelements(list1, Config.getLang(), Config.getLangDir(), ".ini");
    language();
    textField4.setText(Config.getSocksPort() > 0 ? Config.getSocksPort() + "" : "");
    textField5.setText(Config.getLocalPort() > 0 ? Config.getLocalPort() + "" : "");
    textField6
        .setText((Config.getUs() != null && Config.getUs().length() > 0) ? Config.getUs() : "");
    textField7.setText(Config.getSync());
    textField8.setText(Config.getUpdate());
  ...
  private void ok(ActionEvent e) {
    ...
    if (textField4.getText().length() != 0) {
      try {
        ...
        if (sp < 1) {
          JOptionPane.showMessageDialog(null, textField4.getText() + " is an invalid number",
    ...
    if (textField5.getText().length() != 0) {
      try {
        ...
        if (lp < 1) {
          JOptionPane.showMessageDialog(null, textField5.getText() + " is an invalid number",
              "Invalid Number", JOptionPane.ERROR_MESSAGE);
          return;
        }
      } catch (NumberFormatException nfe) {
    ...
    if (textField6.getText().length() == 16) {
      Config.setUs(textField6.getText()); // FIXME not fully checking the id
    } else if (textField6.getText().length() != 0) {
      JOptionPane.showMessageDialog(null, textField6.getText() + " is an invalid Id", "Invalid Id",
          JOptionPane.ERROR_MESSAGE);
      return;
    }
    Config.setSocksPort(sp);
    Config.setLocalPort(lp);
    Config.setLang(lang);
    Config.setSync(sync);
    Config.setUpdate(update);
    if (alert_on_message) {
      Config.setAlert_on_message(1);
    } else {
      Config.setAlert_on_message(0);
    }

    if (alert_on_status_change) {
      Config.setAlert_on_status_change(1);
    } else {
      Config.setAlert_on_status_change(0);
    }
    ...
    if (buddyStart) {
      Config.setBuddyStart(1);
    } else {
      Config.setBuddyStart(0);
    }

    if (updateStart) {
      Config.setUpdateStart(1);
    } else {
      Config.setUpdateStart(0);
    }

    if (file) {
      Config.setTransferonstart(1);
    } else {
      Config.setTransferonstart(0);
    }

    if (page) {
      Config.setPageactive(1);
    } else {
      Config.setPageactive(0);
    }

    if (showlog) {
      Config.setVisiblelog(1);
    } else {
      Config.setVisiblelog(0);
    }
    ...
    if (obfsproxy) {
      Config.setObfsproxy(1);
    } else {
      Config.setObfsproxy(0);
    }

    if (ClickableLinks) {
      Config.setClickableLinks(1);
    } else {
      Config.setClickableLinks(0);
    }

    if (offlineMod) {
      Config.setOfflineMod(1);
    } else {
  ...
  private void update(ActionEvent e) {
    Config.setNowstartupdate(textField8.getText());
    Config.setAllcheckupdate(1);
  }

  private void sync(ActionEvent e) {
    Config.setNowstart(textField7.getText());
  }
  ...
  private void list1ValueChanged(ListSelectionEvent e) {
    ...
    Config.setLang(list1.getSelectedValue().toString());
  }
      ...
      //======== panel1 ========
      {
            ...
            panel1Layout.createParallelGroup()
                .addGroup(panel1Layout.createSequentialGroup()
                    ...
                    .addGroup(panel1Layout.createParallelGroup()
                        .addComponent(checkBox12, GroupLayout.PREFERRED_SIZE, 306,
                            GroupLayout.PREFERRED_SIZE)
                        .addComponent(checkBox2, GroupLayout.PREFERRED_SIZE, 306,
                            GroupLayout.PREFERRED_SIZE)
                        .addComponent(checkBox4, GroupLayout.PREFERRED_SIZE, 306,
                            GroupLayout.PREFERRED_SIZE)
                        .addComponent(checkBox5, GroupLayout.PREFERRED_SIZE, 306,
                            GroupLayout.PREFERRED_SIZE)
                        .addComponent(checkBox7, GroupLayout.PREFERRED_SIZE, 306,
                            GroupLayout.PREFERRED_SIZE)
                        .addComponent(checkBox8, GroupLayout.PREFERRED_SIZE, 306,
                            GroupLayout.PREFERRED_SIZE)
                        .addComponent(checkBox10, GroupLayout.PREFERRED_SIZE, 306,
                            GroupLayout.PREFERRED_SIZE))
        ...
        panel1Layout.setVerticalGroup(
            panel1Layout.createParallelGroup()
                .addGroup(panel1Layout.createSequentialGroup()
                    .addGap(22, 22, 22)
                    .addComponent(checkBox12, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                        GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                    .addComponent(checkBox2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                        GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        panel3Layout.setHorizontalGroup(
            panel3Layout.createParallelGroup()
                .addGroup(panel3Layout.createSequentialGroup()
                    .addGroup(
                        panel3Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                            .addGroup(panel3Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(checkBox3, GroupLayout.DEFAULT_SIZE,
                                    GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(panel3Layout.createSequentialGroup()
                                .addGap(12, 12, 12)
                                .addComponent(textField7, GroupLayout.DEFAULT_SIZE,
                                    GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            ...
                            .addGroup(GroupLayout.Alignment.LEADING,
                                panel3Layout.createSequentialGroup()
                                    .addGap(130, 130, 130)
                                    .addComponent(button2, GroupLayout.PREFERRED_SIZE, 100,
                                        GroupLayout.PREFERRED_SIZE)))
                    .addContainerGap())
        );
        panel3Layout.setVerticalGroup(
            panel3Layout.createParallelGroup()
                .addGroup(panel3Layout.createSequentialGroup()
                    ...
                    .addComponent(label8)
                    .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                    .addComponent(textField7, GroupLayout.PREFERRED_SIZE, 22,
                        GroupLayout.PREFERRED_SIZE)
                    .addGap(18, 18, 18)
                    .addComponent(button2, GroupLayout.PREFERRED_SIZE, 23,
                        GroupLayout.PREFERRED_SIZE)
                    .addGap(44, 44, 44)
                    .addComponent(checkBox3, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                        GroupLayout.PREFERRED_SIZE)
                    .addGap(52, 52, 52))
        );
      }
      ...
      //======== panel4 ========
      {
            ...
            panel4Layout.createParallelGroup()
                .addGroup(panel4Layout.createSequentialGroup()
                    .addGroup(panel4Layout.createParallelGroup()
                        .addGroup(panel4Layout.createSequentialGroup()
                            .addGap(122, 122, 122)
                            .addComponent(button3, GroupLayout.PREFERRED_SIZE, 100,
                                GroupLayout.PREFERRED_SIZE))
                        .addGroup(panel4Layout.createSequentialGroup()
                            .addContainerGap()
                            .addGroup(panel4Layout.createParallelGroup()
                                ...
                                .addComponent(textField8, GroupLayout.DEFAULT_SIZE, 360,
                                    Short.MAX_VALUE)))
                        .addGroup(panel4Layout.createSequentialGroup()
                            .addContainerGap()
                            .addComponent(checkBox6, GroupLayout.DEFAULT_SIZE, 360,
                                Short.MAX_VALUE)))
                    .addContainerGap())
        );
        panel4Layout.setVerticalGroup(
            panel4Layout.createParallelGroup()
                .addGroup(panel4Layout.createSequentialGroup()
                    .addGap(8, 8, 8)
                    .addComponent(label9, GroupLayout.PREFERRED_SIZE, 22,
                        GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(textField8, GroupLayout.PREFERRED_SIZE, 22,
                        GroupLayout.PREFERRED_SIZE)
                    .addGap(18, 18, 18)
                    .addComponent(checkBox6, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                        GroupLayout.PREFERRED_SIZE)
                    .addGap(30, 30, 30)
                    .addComponent(button3, GroupLayout.PREFERRED_SIZE, 23,
                        GroupLayout.PREFERRED_SIZE)
      ...
      //======== panel5 ========
      {
        ...
        panel5Layout.setHorizontalGroup(
            panel5Layout.createParallelGroup()
                .addGroup(panel5Layout.createSequentialGroup()
                    ...
                    .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                    .addComponent(scrollPane1, GroupLayout.PREFERRED_SIZE, 87,
                        GroupLayout.PREFERRED_SIZE)
                    .addContainerGap())
        );
        panel5Layout.setVerticalGroup(
            panel5Layout.createParallelGroup()
                .addGroup(panel5Layout.createSequentialGroup()
                    .addGroup(
                        panel5Layout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
                            .addGroup(panel5Layout.createSequentialGroup()
                                .addGap(25, 25, 25)
                                .addComponent(scrollPane1, GroupLayout.PREFERRED_SIZE, 157,
                                    GroupLayout.PREFERRED_SIZE))
                            .addGroup(panel5Layout.createSequentialGroup()
                                .addGap(35, 35, 35)
                                ...
                                .addComponent(textField11, GroupLayout.PREFERRED_SIZE,
                                    GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(textField12, GroupLayout.PREFERRED_SIZE,
                                    GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED,
                                    GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    ...
                    .addGroup(panel2Layout.createParallelGroup()
                        .addGroup(GroupLayout.Alignment.TRAILING,
                            panel2Layout.createSequentialGroup()
                                .addContainerGap()
                                .addComponent(label4, GroupLayout.PREFERRED_SIZE, 190,
                                    GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(textField4, GroupLayout.PREFERRED_SIZE, 154,
                                    GroupLayout.PREFERRED_SIZE))
                        .addGroup(GroupLayout.Alignment.TRAILING,
                            panel2Layout.createSequentialGroup()
                                .addGroup(
                                    panel2Layout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                                        .addComponent(label5, GroupLayout.DEFAULT_SIZE, 206,
                                            Short.MAX_VALUE)
                                        .addComponent(label6, GroupLayout.DEFAULT_SIZE, 206,
                                            Short.MAX_VALUE))
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(panel2Layout.createParallelGroup()
                                    .addComponent(textField6, GroupLayout.Alignment.TRAILING,
                                        GroupLayout.PREFERRED_SIZE, 154, GroupLayout.PREFERRED_SIZE)
                                    .addComponent(textField5, GroupLayout.Alignment.TRAILING,
                                        GroupLayout.PREFERRED_SIZE, 154,
                                        GroupLayout.PREFERRED_SIZE)))
                        .addGroup(panel2Layout.createSequentialGroup()
                            .addGap(84, 84, 84)
                            .addComponent(label7, GroupLayout.PREFERRED_SIZE, 192,
                                GroupLayout.PREFERRED_SIZE))
                        .addGroup(GroupLayout.Alignment.TRAILING,
                            panel2Layout.createSequentialGroup()
                                .addGap(13, 13, 13)
                                .addComponent(label3, GroupLayout.DEFAULT_SIZE, 359,
                                    Short.MAX_VALUE))
            ...
            panel2Layout.createParallelGroup()
                .addGroup(panel2Layout.createSequentialGroup()
                    ...
                    .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                        .addComponent(textField4, GroupLayout.PREFERRED_SIZE, 22,
                            GroupLayout.PREFERRED_SIZE)
                        .addComponent(label4, GroupLayout.PREFERRED_SIZE, 22,
                            GroupLayout.PREFERRED_SIZE))
                    .addGap(5, 5, 5)
                    .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                        .addComponent(label5, GroupLayout.PREFERRED_SIZE, 22,
                            GroupLayout.PREFERRED_SIZE)
                        .addComponent(textField5, GroupLayout.PREFERRED_SIZE, 22,
                            GroupLayout.PREFERRED_SIZE))
                    .addGap(5, 5, 5)
                    .addGroup(panel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                        .addComponent(label6, GroupLayout.PREFERRED_SIZE, 22,
                            GroupLayout.PREFERRED_SIZE)
                        .addComponent(textField6, GroupLayout.PREFERRED_SIZE, 22,
                            GroupLayout.PREFERRED_SIZE))
                    .addGap(9, 9, 9)
                    .addComponent(checkBox1, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                        GroupLayout.PREFERRED_SIZE)
                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                    ...
                    .addComponent(label3)
                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(label7, GroupLayout.PREFERRED_SIZE, 25,
                        GroupLayout.PREFERRED_SIZE))
        );
      }
