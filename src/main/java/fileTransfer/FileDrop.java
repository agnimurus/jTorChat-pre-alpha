 ...
 * constructor with a <tt>javax.swing.border.Border</tt>. Only
...
public class FileDrop {
   ...
   * more status messages will be displayed to
   ...
   * on, more status messages will be displayed to
   * <tt>out</tt>. A common way to use this constructor is with
   * <tt>System.out</tt> or <tt>System.err</tt>. A <tt>null</tt> value for
   * the parameter <tt>out</tt> will result in no debugging output.
   *
    ...
    if (supportsDnD()) {   // Make a drop listener
      dropListener = new java.awt.dnd.DropTargetListener() {
        ...
        public void dragOver(
            java.awt.dnd.DropTargetDragEvent evt) {   // This is called continually as long as the mouse is
        ...
        public void dropActionChanged(java.awt.dnd.DropTargetDragEvent evt) {
          ...
          // Is this an acceptable drag event?
          if (isDragOk(out,
              evt)) {   //evt.acceptDrag( java.awt.dnd.DnDConstants.ACTION_COPY_OR_MOVE );
            evt.acceptDrag(java.awt.dnd.DnDConstants.ACTION_COPY);
            log(out, "FileDrop: event accepted.");
          }   // end if: drag ok
          else {
   ...
   * will recursively unregister all components contained within
   ...
   * declaration may begin like this:
   * <code><pre>
  ...
  /**
   * This is the event that is passed to the {@link FileDropListener#filesDropped filesDropped(...)}
   * method in your {@link FileDropListener} when files are dropped onto a registered drop target.
   *
   ...
   * programs! When you need to create a {@link java.awt.datatransfer.Transferable} object, use this
   * class to wrap your object. For example:
   * <pre><code>
   *      ...
  ...
  public static class TransferableObject implements java.awt.datatransfer.Transferable {
    ...
    /**
     * Creates a new {@link TransferableObject} that wraps <var>data</var>. Along with the {@link
     * #DATA_FLAVOR} associated with this class, this creates a custom data flavor with a
     * representation class determined from <code>data.getClass()</code> and the MIME type
     * <tt>application/x-net.iharder.dnd.TransferableObject</tt>.
     *
    ...
    /**
     * Creates a new {@link TransferableObject} that will return the object that is returned by
     * <var>fetcher</var>. No custom data flavor is set other than the default {@link
     * #DATA_FLAVOR}.
     *
    ...
    /**
     * Creates a new {@link TransferableObject} that will return the object that is returned by
     * <var>fetcher</var>. Along with the {@link #DATA_FLAVOR} associated with this class, this
     * creates a custom data flavor with a representation class <var>dataClass</var> and the MIME
     * type
     * <tt>application/x-net.iharder.dnd.TransferableObject</tt>.
     *
    ...
    /**
     * Returns <tt>true</tt> if <var>flavor</var> is one of the supported flavors. Flavors are
     * supported using the <code>equals(...)</code> method.
     *
    ...
    /**
     * Instead of passing your data directly to the {@link TransferableObject} constructor, you may
     * want to know exactly when your data was received in case you need to remove it from its
     * source (or do anyting else to it). When the {@link #getTransferData getTransferData(...)}
     * method is called on the {@link TransferableObject}, the {@link Fetcher}'s {@link #getObject
